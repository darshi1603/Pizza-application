...
export const addUser = createAction('[user-details] add user on login', props<{user : User}>());
...
export const decreaseCount  = createAction('[cart] decrease the count  of item' , props<{id : number , item : Cart}>());
